$(function() {
    ...
    //         // console.log($button.parent().find('input').eq(0).val());
    //         var $inputCantidad = $button.parent().find('input').eq(0).val();
    //         var idproducto = $button.parent().attr('codproducto');
            
    //         var rpta = setCantidadProductoCarrito(idproducto,$inputCantidad );
    //         if(rpta.codresult == 1){ //se actualizó correctamente
