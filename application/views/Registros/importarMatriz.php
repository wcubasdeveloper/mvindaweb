...
<div class="row wrapper border-bottom white-bg page-heading">
  ...
  <div class="row wrapper border-bottom white-bg page-heading form-group">
    ...
    <div class="form-group col-lg-2" style="padding-top: 17px;">
      ...
      <input id="txtfechaConsulta"  placeholder="Fecha consulta" readonly class="FechaUI form-control" style="width:130px;"/>
    </div>
    ...
    <div class="col-lg-12 sectionProductos" >
      ...
      <div class="table-responsive">
        <table class="table table-bordered" id="tbMatrizExcel">
          <caption style="caption-side: top-right;text-align: center; color: red;" ></caption>
          <thead>
            <tr>
...
$(document).ready(function(){
    ...
    fechaConsulta.val(PrimerDiaMes(FechaHoraHoy(1)));
    $('.FechaUI').datepicker({
        autoSize: true,
