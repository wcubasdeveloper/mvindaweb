...
<div id="wrapper">
			 ...
			 <nav class="navbar navbar-static-top" role="navigation">
					 <div class="navbar-header">
							 ...
							 <a href="#" class="navbar-brand">DISFASA</a>
					 </div>
					 <div class="navbar-collapse collapse" id="navbar">
							 <ul class="nav navbar-nav">
									 ...
									 <li class="dropdown">
											 ...
											 <ul role="menu" class="dropdown-menu">
													 <li><a href="<?=base_url()?>Almacen/Ingreso">Ingreso</a></li>
									 ...
									 <li class="dropdown">
											 ...
											 <ul role="menu" class="dropdown-menu">
													 <li><a href="<?=base_url()?>Compra/Ingreso">Registro</a></li>
									 ...
									 <li class="dropdown">
											 ...
											 <ul role="menu" class="dropdown-menu">
													 <li><a href="<?=base_url()?>Caja/Inicio">Gestion</a></li>
									 ...
									 <li class="dropdown">
											 ...
											 <ul role="menu" class="dropdown-menu">
													 <li><a href="<?=base_url()?>Venta/Ingreso">Registro</a></li>
													 <li><a href="<?=base_url()?>Venta/ReporteDiario">Reporte Diario</a></li>
													 <li><a href="<?=base_url()?>Venta/ReporteRango">Reporte por Rango</a></li>
