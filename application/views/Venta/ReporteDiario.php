...
<div class="row">
   <div class="row wrapper border-bottom white-bg page-heading">
      <div class="col-lg-12">
        <h2>Reporte Diario &nbsp;&nbsp;&nbsp;<strong id="StnCantidadRegistros">-</strong>
          <input id="TxtFechaConsulta" readonly class="FechaUI" style="width:130px;"/>
          <select id="SelEstado">
            <option value="0">TODOS</option>
            <option value="1">ACTIVO</option>
            <option value="3">ANULADO</option>
          </select>
          <button class="btn btn-sm btn-primary pull-right m-t-n-xs" type="button" onclick="ConsultaReporteDiario()"><strong>Consulta</strong></button>
        </h2>
      </div>
   ...
   <div class="row wrapper border-bottom white-bg page-heading">
      <div class="col-lg-12">
        <table class="table table-bordered" id="TbReporteDiario">
            <thead>
              <tr>
                <th>N</th>
                <th>DOCUMENTO</th>
...
$(document).ready(function(){
  ...
  TbReporteDiarioCuerpo = $('#TbReporteDiario tbody');
  TxtFechaConsulta = $('#TxtFechaConsulta');
  SelEstado = $('#SelEstado');

  TxtFechaConsulta.val(FechaHoraHoy(1));
  $('.FechaUI').datepicker({
    autoSize: true,
...
//
function ConsultaReporteDiario() {
  var FechaConsulta = FechaMySQL(TxtFechaConsulta.val());
  var CodEstado = SelEstado.val();
  var Procedimiento = 'ProcVenta';
  var Parametros = FechaConsulta + '|' + CodEstado;
  var Indice = 12;
  ...
  $.post(URL, Data, function (Data) {
    ...
    TbReporteDiarioCuerpo.append(FilasHTML);
